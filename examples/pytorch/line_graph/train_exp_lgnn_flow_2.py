...
import sbm
import exp_lgnn_flow_2
from exp_lgnn_flow_2 import pm_pd
...
model = exp_lgnn_flow_2.GNN(feats, args.radius, K, dev).to(dev)
...
##    for j, [g, lg, deg_g, deg_lg, pm_pd] in enumerate(training_loader):
    for j in range(args.n_graphs):
        with th.no_grad():	
            ...
            adj_diag_lg_deg_inverse = th.mm(lg_a1, diag_lg_deg_inverse)
