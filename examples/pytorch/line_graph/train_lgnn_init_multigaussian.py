...
import sbm
import lgnn_init_multigaussian
import lgnn_relu
from lgnn_init_multigaussian import pm_pd
...
feats = [5] + [args.n_features] * args.n_layers + [K]

if args.model == 'lgnn':
    model = lgnn_init_multigaussian.GNN(feats, args.radius, K, dev).to(dev)
