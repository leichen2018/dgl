...
class GNNModule(nn.Module):
    ...
    def forward(self, g, x, deg_g, g_t, g_tt, mask_g_t, mask_g_tt):
        x_list = []

        x_list.append(th.mm(mask_g_t, x))
        x_list.append(th.mm(mask_g_tt, x))
...
class GNN(nn.Module):
    ...
    def forward(self, g, deg_g, g_t, g_tt, mask_g_t, mask_g_tt):
        x = deg_g
        
        for module in self.module_list:
            x = module(g, x, deg_g, g_t, g_tt, mask_g_t, mask_g_tt)
        
        x = self.module_final(g, x, deg_g, g_t, g_tt, mask_g_t, mask_g_tt)
        return x
